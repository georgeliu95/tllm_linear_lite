 ...
 *
 * This file is derived from TensorRT-LLM's include/tensorrt_llm/kernels/archCondition.h.
 *
 * Changes from the original:
 *   - Replaced includes: tensorrt_llm/common/config.h -> trtllm_cutlass_compat.h
 *   - Kept:    All arch detection logic (is_device, is_arch_specific, is_match, is_major, is_compatible)
 */
