 ...
 *
 * This file is derived from TensorRT-LLM's cutlass_extensions/gemm_configs.h.
 *
 * Changes from the original:
 *   - Replaced includes: tensorrt_llm/common/{config,assert,tllmException}.h
 *     -> trtllm_cutlass_compat.h (provides namespace macros + TLLM_CHECK_WITH_INFO)
 *   - Kept:    All enum definitions (CutlassTileConfig, CutlassTileConfigSM90/100/120,
 *              ClusterShape, MainloopScheduleType, EpilogueScheduleType, etc.)
 *   - Kept:    CutlassGemmConfig struct and all helper functions
 */
