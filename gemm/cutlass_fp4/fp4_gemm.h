 ...
 *
 * This file is derived from TensorRT-LLM's kernels/cutlass_kernels/include/fp4_gemm.h.
 *
 * Changes from the original:
 *   - Replaced includes: tensorrt_llm/common/config.h -> trtllm_cutlass_compat.h
 *   - Replaced includes: tensorrt_llm/common/quantization.h -> removed (FP4GemmType defined locally)
 *   - Replaced includes: cutlass_extensions/gemm_configs.h -> gemm_configs.h (local copy)
 *   - Kept:    CutlassFp4GemmRunnerInterface, CutlassFp4GemmRunner, FP4GemmType enum
 */
...
// FP4GemmType defined locally below (was quantization.h)
