...
Dispatches FP4 GEMM to the best available backend based on problem shape:
  ...
  - cublaslt:  All shapes, uses cuBLASLt BlockScaleGemm API. Requires SWIZZLED scales.
  - cutlass:   (TODO) Best performance, CUTLASS 3.x templates.
...
def nvfp4_gemm(
    ...
    Args:
        ...
        backend:      Backend selection:
                      - "auto": auto-select based on M (cuda_core for M<=16, else cublaslt)
